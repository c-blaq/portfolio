...
const OfferCard = () => {
  return (
    <div className="p-5 flex-1 lg:p-10 bg-primary-dark even:bg-secondary-blue group">
      ...
      <h3 className="font-bigShoulder text-2xl sm:text-4xl md:text-5xl uppercase font-bold mb-3 sm:mb-5 text-textBlue group-even:text-white before:absolute before:left-0 before:w-2 before:h-full relative group-odd:before:bg-secondary-blue group-even:before:bg-white">
        Web development
      </h3>
